...
namespace Personel_Takip_Programı
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurt_OtomasyonuDataSet5.Giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.yurt_OtomasyonuDataSet5.Giderler);
