...
namespace Personel_Takip_Programı
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurt_OtomasyonuDataSet4.Ogrenci' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrenciTableAdapter.Fill(this.yurt_OtomasyonuDataSet4.Ogrenci);
